...
class duffingx3HB(adaptiveHarmonicBalance):
    r"""
    ...
    def residualFunction(self, 
        ...
        residual = self.E_hn_c_List[0] @ (a + self.delta* v + self.alpha* x + self.beta* x**3 - self.gamma* np.cos(self.omega*tVec))
    ...
    def getInitialGuess(self, 
        ...
        initGuess1[1] = 5.4184e-1
        initGuess1[2] = 8.3573e-1

        initGuess2 = np.zeros(nrCoeffs)
        initGuess2[1] = -7.4158e-1
        initGuess2[2] = 5.6396e-1

        initGuess3 = np.zeros(nrCoeffs)
        initGuess3[1] = -2.1302e-1
        initGuess3[2] = 2.5786e-1
